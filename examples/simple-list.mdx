...
description: Build a minimal list interface with custom styling
---
...
For a more feature-rich list with built-in filtering and status bar, see the [Default List example](https://github.com/charmbracelet/bubbletea/tree/main/examples/list-default).

## Source Code

View the complete source code: [examples/list-simple](https://github.com/charmbracelet/bubbletea/tree/main/examples/list-simple)
